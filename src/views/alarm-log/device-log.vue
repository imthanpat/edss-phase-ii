    ...
    <v-col cols="12" class="pa-2">
      ...
      >
        <template #item-device_name="item"
          ><strong>{{ item.device_name }}</strong></template
        >
        <template #item-alarm_status="item">
          <v-chip
            v-if="item.alarm_status.trim() == 'Active'"
            size="small"
            color="error"
            >{{ item.alarm_status }}</v-chip
          >
          <v-chip
            v-if="item.alarm_status.trim() == 'Clear'"
            size="small"
            color="success"
            >{{ item.alarm_status }}</v-chip
          >
